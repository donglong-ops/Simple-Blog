 ...
 * @author Cyrus
 */
@WebServlet(name = "SocialNetworkController", urlPatterns = {"/SocialNetworkController"})
public class SocialNetworkController extends HttpServlet {

    private static final String ERROR_PAGE = "error.jsp";
    private static final String SUCCESS_PAGE = "homePage.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("Error SocialNetworkController : " + ex.getMessage());
        } finally {
